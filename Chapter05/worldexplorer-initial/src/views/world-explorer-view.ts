...
export class WorldExplorerHTMLView implements WorldExplorerView { 
    ...
    constructor() {
        this._countrySelect = document.getElementById('countrySelect') as HTMLSelectElement;if (!this._countrySelect) { 
            throw new Error("Could not initialize the view. The 'countrySelect' element id was not found. Was the template changed?"); 
        } 
        
        this._indicatorSelect = document.getElementById('indicatorSelect') as HTMLSelectElement; if (!this._indicatorSelect) { 
